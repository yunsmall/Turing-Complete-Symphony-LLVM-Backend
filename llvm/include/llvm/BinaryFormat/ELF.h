...
enum {
  ...
  EM_SYMPHONY = 998,//图灵完备symphony架构
};
...
// SYMPHONY Specific e_flags
enum : unsigned {
  EF_SYMPHONY_NOREORDER = 0x00000001,  // Don't reorder instructions
  EF_SYMPHONY_PIC       = 0x00000002,  // Position independent code
  EF_SYMPHONY_ARCH_32   = 0x50000000,  // CPU032 instruction set per linux not elf.h
  EF_SYMPHONY_ARCH      = 0xf0000000,  // Mask for applying EF_CPU0_ARCH_ variant
};

// ELF Relocation types for SYMPHONY
enum {
#include "ELFRelocs/Symphony.def"
};
